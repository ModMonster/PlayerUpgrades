package com.modmonster.playerupgrades;
...
public class PlayerupgradesModVariables {
	public PlayerupgradesModVariables(PlayerupgradesModElements elements) {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote) {
			...
			if (mapdata != null)
				PlayerupgradesMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				PlayerupgradesMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
	...
	public static class MapVariables extends WorldSavedData {
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (!world.getWorld().isRemote)
				PlayerupgradesMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
