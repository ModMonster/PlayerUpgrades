...
package com.modmonster.playerupgrades.block;
...
import com.modmonster.playerupgrades.procedures.ApplyUpgradesProcedure;
import com.modmonster.playerupgrades.itemgroup.PlayerUpgradesTabItemGroup;
import com.modmonster.playerupgrades.gui.PlayerUpgraderGuiGui;
import com.modmonster.playerupgrades.PlayerupgradesModElements;

@PlayerupgradesModElements.ModElement.Tag
public class PlayerUpgraderBlock extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:player_upgrader")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			BlockState blockstate = world.getBlockState(pos);
			{
				...
				ApplyUpgradesProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Upgrader");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new PlayerUpgraderGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("player_upgrader");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new PlayerUpgraderGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
