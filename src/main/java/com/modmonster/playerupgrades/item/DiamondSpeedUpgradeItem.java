...
public class DiamondSpeedUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:diamond_speed_upgrade")
	public static final Item block = null;
	public DiamondSpeedUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("diamond_speed_upgrade");
		}
