...
public class IronHealthUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:iron_health_upgrade")
	public static final Item block = null;
	public IronHealthUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_health_upgrade");
		}
