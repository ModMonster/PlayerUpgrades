...
public class FlyUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:fly_upgrade")
	public static final Item block = null;
	public FlyUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 15);
	}
