...
public class IronJumpBoostUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:iron_jump_boost_upgrade")
	public static final Item block = null;
	public IronJumpBoostUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_jump_boost_upgrade");
		}
