...
public class DiamondHealthUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:diamond_health_upgrade")
	public static final Item block = null;
	public DiamondHealthUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("diamond_health_upgrade");
		}
