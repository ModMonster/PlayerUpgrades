...
package com.modmonster.playerupgrades.gui;
...
public class PlayerUpgraderGuiGui extends PlayerupgradesModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public PlayerUpgraderGuiGui(PlayerupgradesModElements instance) {
		super(instance, 19);
