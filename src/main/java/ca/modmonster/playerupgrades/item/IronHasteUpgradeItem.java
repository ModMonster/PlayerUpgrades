...
public class IronHasteUpgradeItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:iron_haste_upgrade")
	public static final Item block = null;
	public IronHasteUpgradeItem(PlayerupgradesModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("iron_haste_upgrade");
		}
