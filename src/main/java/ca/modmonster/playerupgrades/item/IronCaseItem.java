...
public class IronCaseItem extends PlayerupgradesModElements.ModElement {
	@ObjectHolder("playerupgrades:iron_case")
	public static final Item block = null;
	public IronCaseItem(PlayerupgradesModElements instance) {
		super(instance, 2);
	}
