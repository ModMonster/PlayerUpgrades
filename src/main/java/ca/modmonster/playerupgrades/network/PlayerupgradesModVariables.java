...
public class PlayerupgradesModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, PlayerupgradesMod.MODID);

	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		PlayerupgradesMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
