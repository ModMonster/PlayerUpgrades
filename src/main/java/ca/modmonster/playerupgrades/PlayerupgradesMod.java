...
import ca.modmonster.playerupgrades.init.PlayerupgradesModMenus;
import ca.modmonster.playerupgrades.init.PlayerupgradesModItems;
import ca.modmonster.playerupgrades.init.PlayerupgradesModBlocks;
import ca.modmonster.playerupgrades.init.PlayerupgradesModBlockEntities;

@Mod("playerupgrades")
public class PlayerupgradesMod {
	public static final Logger LOGGER = LogManager.getLogger(PlayerupgradesMod.class);
	public static final String MODID = "playerupgrades";

	public PlayerupgradesMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		PlayerupgradesModBlocks.REGISTRY.register(modEventBus);
		PlayerupgradesModBlockEntities.REGISTRY.register(modEventBus);
		PlayerupgradesModItems.REGISTRY.register(modEventBus);
		PlayerupgradesModTabs.REGISTRY.register(modEventBus);
		PlayerupgradesModVariables.ATTACHMENT_TYPES.register(modEventBus);
		PlayerupgradesModMenus.REGISTRY.register(modEventBus);
